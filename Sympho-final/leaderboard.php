...
<head>
    ...
    <title>Leaderboard - WebTechXpo</title>
    <style>
...
<body>
    ...
    <div class="leaderboard">
        <h2>Leaderboard</h2>
        <div class="note">#Top 10 teams will be selected for the next round</div>
        <div id="podium-container"></div>
        <ul id="leaderboard-list"></ul>
        <div class="button-container">
            <button class="refresh-btn" onclick="updateLeaderboard()">Refresh</button>
        ...
        function updateLeaderboard() {
            fetch('fetch_scores.php')
                ...
                .then(data => {
                    ...
                    secondPlace.title = players[1].name; // Add title for hover
                    ...
                    firstPlace.title = players[0].name; // Add title for hover
                    ...
                    thirdPlace.title = players[2].name; // Add title for hover
